...
def login():
    ...
    time.sleep(0.05)
    print '\x1b[1;97m[3]\x1b[1;92mContact Me On Fb    '
    time.sleep(0.05)
...
def login1():
    ...
    try:
        ...
        time.sleep(0.05)
        print logo
        print '\x1b[1;93m----------------- = Commands By Hamayun = -----------------'
...
def menu():
    ...
    time.sleep(0.05)
    print '\x1b[92;49;41m----------------- = Tool By Hamayun = \x1b[1;97m-----------------'
    print '\x1b[1;95m[1]\x1b[0;33mStart Cloning                    \x1b[1;97m'
    time.sleep(0.05)
...
def pilih_super():
    ...
    if peak == '':
        ...
        if peak == '1':
            os.system('clear')
            print '\x1b[1;93m---------------- = Tool By Hamayun = -----------------'
            print logo
    ...
    print '\x1b[1;94m\xe2\x80\xa2----------------- = By Hamayun Khan = -----------------'
